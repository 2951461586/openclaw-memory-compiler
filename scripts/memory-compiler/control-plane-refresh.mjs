...
function usage() {
  console.error('Usage: node plugins/memory-compiler/scripts/memory-compiler/control-plane-refresh.mjs <config.json | ->');
  process.exit(2);
}
...
const result = await commands.memoryCompilerRefresh(config, payload);
